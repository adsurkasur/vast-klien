...
const SidebarBaseButton = React.forwardRef<HTMLElement, SidebarBaseButtonProps>(
  function SidebarBaseButton({
    asChild = false,
    component = "button",
    className,
    children,
    ...
    return (
      <>{React.createElement(Comp as React.ElementType, { ref, className, ...props }, children as ReactNode)}</>
    );
  }
);
